    ...
    return (
        <div className='container mx-auto text-center mt-20'>
         ...
         {/* name of each tab group should be unique */}
          ...
          <input onClick={()=>setShowTab('cart')} type="radio" name="my_tabs_1" className="tab w-32 rounded-3xl font-bold checked:text-white text-lg checked:bg-linear-to-r checked:from-[#4F39F6] checked:to-[#9514FA]" aria-label="Cart" />
          </div>
        </div>
    );
};
