    ...
    return (
        <div>
            <div className='text-center'>
             <h3 className='text-3xl md:text-5xl font-bold mb-4'>Simple, Transparent Pricing</h3>
            <p className='text-[#627382] mb-8'>Choose the plan that fits your needs. Upgrade or downgrade anytime.</p>
            </div>
            <div className='grid grid-cols-1 md:grid-cols-3 justify-items-center  gap-4 lg:max-w-7xl mx-auto '>
                <div className='w-full max-w-96   bg-[#F2F2F2] p-6 rounded-2xl transform transition-transform hover:-translate-y-2 ease-in-out duration-500
                shadow-[0_15px_25px_rgba(79,57,246,0.5)]'>
                ...
                <div className='w-full max-w-96 bg-linear-to-r from-[#4F39F6] to-[#9514FA] p-6 rounded-2xl transform  transition-transform hover:-translate-y-2 ease-in-out duration-500
                shadow-[0_15px_25px_rgba(79,57,246,0.5)]
                '>
