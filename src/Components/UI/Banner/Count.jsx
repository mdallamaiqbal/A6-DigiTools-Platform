    ...
    return (
        <div className='lg:container mx-auto lg:px-48 py-14 bg-linear-to-r from-[#4F39F6] to-[#9514FA]'>
          <div className='grid grid-cols-1 md:grid-cols-3 relative'>
            ...
            <h3 className='font-extrabold text-4xl md:text-6xl text-[#FFF]'>50K+</h3>
            ...
            <div className='flex flex-col items-center justify-center'>
            <h3 className='font-extrabold text-4xl md:text-6xl text-[#FFF]'>200+</h3>
            ...
            <div className='flex flex-col items-center justify-center'>
            <h3 className='font-extrabold text-4xl md:text-6xl text-[#FFF]'>4.9</h3>
